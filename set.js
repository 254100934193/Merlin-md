...
module.exports = { session: process.env.SESSION_ID || 'keith',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/254100934193/Merlin-md',
    ...
    DEV: process.env.DEV_NAME || "Mungai",              
    AUTO_READ_MESSAGES: process.env.AUTO_READ_MESSAGES || "yes",
    AUTO_BLOCK: process.env.AUTO_BLOCK || 'no', 
    GCF: process.env.GROUP_CONTROL || 'no', 
    GREET : process.env.GREET || "no", 
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || 'viewed by merlin md by Mungai yobih',   
    ...
    CAPTION : process.env.CAPTION || "MERLIN-MD",
    BOT : process.env.BOT_NAME || 'MERLIN_MD',
